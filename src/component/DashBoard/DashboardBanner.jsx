...
const DashboardBanner = ({handleDisplay, display}) => {
    return (
        <div className="text-center text-white bg-violet-500 pt-10 py-10 space-y-5">
            ...
            <div className="flex justify-center space-x-5 mt-5">
                ...
                <button onClick={() =>handleDisplay("cart")} className={display == 'cart'? `btn btn-primary text-white rounded-3xl px-10` : `btn btn-outline btn-primary text-white rounded-3xl px-10`}>Cart</button>
                
                {/* <button onClick={()=>handleDisplay("wishlist")} className="btn btn-outline btn-primary text-white rounded-3xl px-10">Wishlist</button> */}
                <button onClick={()=>handleDisplay("wishlist")} className={display == 'wishlist' ? `btn btn-primary text-white rounded-3xl px-10` : `btn btn-outline btn-primary text-white rounded-3xl px-10`}>Wishlist</button>
            </div>
        </div>
    );
};
